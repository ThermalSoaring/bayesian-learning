#
# Connect with FlightGear
#
# From:
#    https://code.google.com/p/cortex-ap/source/
#      browse/trunk/Software/Python/FlightGear.py
#
# But actually, that was just from FlightGear's scripts/python/:
#    http://sourceforge.net/p/flightgear/flightgear/ci/
#      next/tree/scripts/python/FlightGear.py
#
